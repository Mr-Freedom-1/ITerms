...
const resources = {
  en: {
    translation: {
      ...
      'post-title-h3':'Latest Blog Articles',
      'post-title-p':'What\'s New',
      'post-title-h4':'More than 140,000 businesses use iTerms. Join our community of amazing companies!',
      ...
      'discover_posibilities': 'discover posibilities',
      'make_sure': 'make sure',
      'Compare_competitors': 'Compare with competitors',
      'Hosting_Policies': 'Hosting Policies',
      ...
      'loading': 'Loading...',
      'error': 'Error:',
      'read_more': 'Read more', // used in BlogDetail Generate
      // for BlogLayout
      ...
      'sign_in': 'Sign in', // use in SignUp
      'or': 'Or',
      'email': 'Email', // use in SignUp
      'enter_email': 'Enter the Email', // use in SignUp
      'password': 'Password', // use in SignUp
      'enter_password': 'At least 8 characters long', // use in SignUp
      'sign_in_with': 'Sign in with', // use in SignUp
      'have_not_account':'Don\'t have an account?',
      'sign_up': 'Sign up', // use in SignUp
      // for SignUp
      'your_name': 'Your Name',
      ...
      'any_payment_processors': 'Any Payment Processors', // use in Generate
      'integrate_to_website': 'Integrate to Website',
      'hosted_policies': 'Hosted Policies',
      'embed_site': 'Embed On Your Site', // use in Generate
      'regular_doc_updates': 'Regular Doc Updates',
      'customize_&_download': 'Customize & Download',
      'TXT': 'TXT Format',
      'HTML': 'HTML File (.html)',
      'DOCX': 'DOCX File (.doc)',
      'unlimited_downloads': 'Unlimited downloads', // use in Generate
      ...
      'footer_learn': 'Learn more', // use in Generate
      ...
      'privacy_create': 'Create a free terms and conditions agreement (aka terms of use or terms of service) for your website or app', // use in Generate
      ...
      'privacy_generate': 'Generate', // use in Generate
  ...
  ua: {
    translation: {
      ...
      'post-title-h3':'Останні статті блогу',
      'post-title-p':'Що нового',
      'post-title-h4':'Понад 140 000 компаній використовують iTerms. Приєднуйтесь до нашої спільноти чудових компаній!',
      ...
      'Powered_by_AI': 'На основі ШІ',
      'your': ' вашу ',
      'Terms_of_Use': ' Використання ',
      'or_gen': 'або ',
      'for': ' ',
      'free': 'безкоштовно ',
      'take_a_look': 'поглянь',
      'discover_posibilities': 'відкрити можливості',
      'make_sure': 'переконайтеся',
      'Compare_competitors': 'Порівняйте з конкурентами',
      'Hosting_Policies': 'Політика Хостингу',
      ...
      'privacy_policy': 'Конфіденційность',
      ...
      'privacy_swiper_privacy': 'Конфіденційність',
      'privacy_swiper_statement': 'Заява або юридичний документ, який розкриває деякі або всі розкриття даних клієнта чи клієнтів.',
      'privacy_swiper_generate': 'Генерувати',
      'privacy_swiper_learn': 'Більше інфо',
      'privacy_swiper_terms': 'Правила використання',
      'privacy_swiper_legal': 'Це юридичні угоди між постачальником послуг і особою, яка хоче скористатися цією послугою.',
      'privacy_swiper_cookie': 'Політику cookie ',
      'privacy_swiper_disclaimer': 'Застереження',
      'privacy_swiper_refund': 'Відшкодування',
